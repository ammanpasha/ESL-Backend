...
<head>
    ...
    <title>All Jobs :: Express Shipping</title>
</head>
            ...
            $.ajax(settings).done(function (r) {
                ...
                r.forEach(e => {
                    ...
                    var row = `<tr>
                        ...
                        <td>${e.hbl}</td>
                        <td>${e.equip}</td>
                        <td><a href="view.php?idx=${e.idx}" class="btn btn-primary">View</a></td>
                        <td><a href="update.php?idx=${e.idx}" class="btn btn-warning">Edit</a></td>
