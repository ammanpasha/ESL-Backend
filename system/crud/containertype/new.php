...
{
$sql1 = "insert into containertypes(cType,addedOn,addedBy) values ('".$_POST["cType"]."','".date("Y-m-d H:i:s")."',".$_SESSION['idx'].");";
...
<head>
  ...
  <title>Create Container Type</title>
</head>
<!--Auth Check Start-->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="index.php">View Container Types</a>
  ...
  <div class="" id=""
    ...
    <div class="card bg-primary text-white">
      <div class="card-header bg-primary">Add New Container Type</div>
